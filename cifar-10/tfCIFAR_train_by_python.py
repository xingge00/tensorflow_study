...
if __name__ == "__main__":
    max_steps = 1000  # 最大迭代轮数
    batch_size = 128  # 批大小
    cifar10_dir = 'F:\Projects\PycharmProjects\dataset\cifar-10-batches-bin'  # 数据所在路径
    ...
    saver.restore(sess, 'net/CIFAR-10net/my_net.ckpt')
    #启动图片数据增强队列
    ...
    #test accuracy:0.805
    # 保存模型
    saver.save(sess, 'net/CIFAR-10net/my_net.ckpt')
